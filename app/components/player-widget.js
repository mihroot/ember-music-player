...
export default Ember.Component.extend({
  ...
  sceneInit($Container) {
    ...
    //Event listeners
    this.$(window).bind('resize.player_widget', function() {
      return _Self._onWindowResize.apply(_Self, arguments);
    });
    this.$(document).bind('mousemove.player_widget', function() {
      return _Self._onMouseMove.apply(_Self, arguments);
    });
  ...
  moveToObject: function(_Object) {
    ...
    var _obj_moving_from_offset = 0;
    var _obj_moving_from_z = 0;
    ...
    if (_Self._window_focus) {
      ...
      _Self._MovementTween = new window.TWEEN.Tween({
          value: _z_distance_to_run
        })
        .to({
          value: 0
        }, 2000)
      ...
      _Self._moveCameraXY(_Camera.position, {
        x: _Object.position.x,
        y: _Object.position.y + _Self._camera_initial_y
      }, 1500);
